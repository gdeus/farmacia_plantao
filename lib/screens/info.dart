  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Text("Aplicativo criado baseado no Diário Oficial do Município de São Miguel do Iguaçu (Edição nº 2235 | 20/01/2020) onde é definido os plantões das farmácias em 2020. Caso o aplicativo esteja com problema ou informando a farmácia incorrreta "
