...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    listaPlantaoAux =
        listaPlantao.where((element) => (element.fim.isAfter(dataDeHoje) &&
            element.inicio.isBefore(dataDeHoje)) || isToday(element.inicio) ||
            isToday(element.fim)).toList();
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            FlatButton(
                              onPressed: () {
                                UrlLauncher.launch(
                                    'https://www.google.com/maps/search/?api=1&query=${farmaciaDePlantao
                                        .latitude},${farmaciaDePlantao
                                        .longitude}');
                              },
                              child: Row(
                                children: <Widget>[
